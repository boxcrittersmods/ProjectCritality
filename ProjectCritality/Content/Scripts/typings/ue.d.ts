...
declare class SIOJConvert extends UObject { 
	static Load(ResourceName: string): SIOJConvert;
	static Find(Outer: UObject, ResourceName: string): SIOJConvert;
	static GetDefaultObject(): SIOJConvert;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SIOJConvert;
	static C(Other: UObject | any): SIOJConvert;
}

declare class SIOJLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): SIOJLibrary;
	static Find(Outer: UObject, ResourceName: string): SIOJLibrary;
	static GetDefaultObject(): SIOJLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SIOJLibrary;
	static StructToJsonObject(AnyStruct: Property): SIOJsonObject;
	static StringToJsonValueArray(JsonString: string,OutJsonValueArray?: SIOJsonValue[]): {OutJsonValueArray: SIOJsonValue[], $: boolean};
	static SaveStructToJsonFile(AnyStruct: Property,FilePath: string): boolean;
	static PercentEncode(Source: string): string;
	static LoadJsonFileToStruct(FilePath: string,AnyStruct: Property): boolean;
	static JsonObjectToStruct(JsonObject: SIOJsonObject,AnyStruct: Property): boolean;
	static Conv_StringToJsonValue(inString: string): SIOJsonValue;
	static Conv_JsonValueToJsonObject(InValue: SIOJsonValue): SIOJsonObject;
	static Conv_JsonValueToInt(InValue: SIOJsonValue): number;
	static Conv_JsonValueToFloat(InValue: SIOJsonValue): number;
	static Conv_JsonValueToBytes(InValue: SIOJsonValue): number[];
	static Conv_JsonValueToBool(InValue: SIOJsonValue): boolean;
	static Conv_JsonObjectToString(InObject: SIOJsonObject): string;
	static Conv_JsonObjectToJsonValue(InObject: SIOJsonObject): SIOJsonValue;
	static Conv_IntToJsonValue(inInt: number): SIOJsonValue;
	static Conv_FloatToJsonValue(InFloat: number): SIOJsonValue;
	static Conv_BytesToJsonValue(InBytes: number[]): SIOJsonValue;
	static Conv_BoolToJsonValue(InBool: boolean): SIOJsonValue;
	static Conv_ArrayToJsonValue(inArray: SIOJsonValue[]): SIOJsonValue;
	static Base64Encode(Source: string): string;
	static Base64Decode(Source: string,Dest?: string): {Dest: string, $: boolean};
	static C(Other: UObject | any): SIOJLibrary;
}

declare type ESIOCallbackType = 'CALLBACK_GAME_THREAD' | 'CALLBACK_BACKGROUND_THREADPOOL' | 'CALLBACK_BACKGROUND_TASKGRAPH' | 'CALLBACK_MAX';
declare var ESIOCallbackType : { CALLBACK_GAME_THREAD:'CALLBACK_GAME_THREAD',CALLBACK_BACKGROUND_THREADPOOL:'CALLBACK_BACKGROUND_THREADPOOL',CALLBACK_BACKGROUND_TASKGRAPH:'CALLBACK_BACKGROUND_TASKGRAPH',CALLBACK_MAX:'CALLBACK_MAX', };
declare class CUBlueprintLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): CUBlueprintLibrary;
	static Find(Outer: UObject, ResourceName: string): CUBlueprintLibrary;
	static GetDefaultObject(): CUBlueprintLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): CUBlueprintLibrary;
	static SetSoundWaveFromWavBytes(InSoundWave: SoundWaveProcedural,InBytes: number[]): void;
	static NowUTCString(): string;
	static MeasureTimerStop(Category: string,bShouldLogResult: boolean): number;
	static MeasureTimerStart(Category: string): void;
	static GetLoginId(): string;
	static Conv_WavBytesToSoundWave(InBytes: number[]): SoundWave;
	static Conv_WavBytesToOpus(InBytes: number[]): number[];
	static Conv_TextureToBytes(Texture: Texture2D,OutBuffer?: number[],Format?: EImageFormatBPType): {OutBuffer: number[], $: boolean};
	static Conv_StringToBytes(inString: string): number[];
	static Conv_SoundWaveToWavBytes(SoundWave: SoundWave): number[];
	static Conv_OpusBytesToWav(InBytes: number[]): number[];
	static Conv_BytesToTexture(InBytes: number[]): Texture2D;
	static Conv_BytesToString(InBytes: number[]): string;
	static CallFunctionOnThread(UFunction: string,ThreadType: ESIOCallbackType,WorldContextObject: UObject): void;
	static C(Other: UObject | any): CUBlueprintLibrary;
}

declare class CUFileComponent extends ActorComponent { 
	static Load(ResourceName: string): CUFileComponent;
	static Find(Outer: UObject, ResourceName: string): CUFileComponent;
	static GetDefaultObject(): CUFileComponent;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): CUFileComponent;
	SaveBytesToFile(Bytes: number[],Directory: string,Filename: string): boolean;
	ReadBytesFromFile(Directory: string,Filename: string,OutBytes?: number[]): {OutBytes: number[], $: boolean};
	ProjectSavedDirectory(): string;
	ProjectDirectory(): string;
	ProjectContentsDirectory(): string;
	static C(Other: UObject | any): CUFileComponent;
}

declare class PosCoversion extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): PosCoversion;
	static Find(Outer: UObject, ResourceName: string): PosCoversion;
	static GetDefaultObject(): PosCoversion;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): PosCoversion;
	static UnrealToBoxCritters(pos: Vector): Vector2D;
	static BoxCrittersToUnreal(bcPos: Vector2D): Vector;
	static C(Other: UObject | any): PosCoversion;
}
...
declare class SIOMessageConvert extends UObject { 
	static Load(ResourceName: string): SIOMessageConvert;
	static Find(Outer: UObject, ResourceName: string): SIOMessageConvert;
	static GetDefaultObject(): SIOMessageConvert;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SIOMessageConvert;
	static C(Other: UObject | any): SIOMessageConvert;
}

declare class SocketIOFunctionLibrary extends BlueprintFunctionLibrary { 
	static Load(ResourceName: string): SocketIOFunctionLibrary;
	static Find(Outer: UObject, ResourceName: string): SocketIOFunctionLibrary;
	static GetDefaultObject(): SocketIOFunctionLibrary;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SocketIOFunctionLibrary;
	static ConstructSocketIOComponent(WorldContextObject: UObject): SocketIOClientComponent;
	static C(Other: UObject | any): SocketIOFunctionLibrary;
}

declare type ESIOJ_JsonType = 'JSON_Bool' | 'JSON_Number' | 'JSON_String' | 'JSON_Object' | 'JSON_MAX';
declare var ESIOJ_JsonType : { JSON_Bool:'JSON_Bool',JSON_Number:'JSON_Number',JSON_String:'JSON_String',JSON_Object:'JSON_Object',JSON_MAX:'JSON_MAX', };
declare class SIOJ_NamedType { 
	Name: string;
	Type: ESIOJ_JsonType;
	bIsArray: boolean;
	clone() : SIOJ_NamedType;
	static C(Other: UObject | any): SIOJ_NamedType;
}

declare class SIOJ_BreakJson extends K2Node { 
	Outputs: SIOJ_NamedType[];
	static Load(ResourceName: string): SIOJ_BreakJson;
	static Find(Outer: UObject, ResourceName: string): SIOJ_BreakJson;
	static GetDefaultObject(): SIOJ_BreakJson;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): SIOJ_BreakJson;
	static C(Other: UObject | any): SIOJ_BreakJson;
}
